...
import 'video_skin/fijkplayer_skin.dart';
import 'video_skin/schema.dart';

class VideoDemo1 extends StatefulWidget {
  const VideoDemo1({Key? key}) : super(key: key);

  @override
  _VideoDemo1State createState() => _VideoDemo1State();
}

class _VideoDemo1State extends State<VideoDemo1> {
  @override
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text("当前tabIdx : ${_curTabIdx.toString()}          当前activeIdx : ${_curActiveIdx.toString()}")
      ],
    );
  }
}
